	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				green: "bg-tile-green text-white hover:bg-tile-green/85 dark:bg-tile-green dark:text-white dark:hover:bg-tile-green/80",
...
{#if href}
	<!-- eslint-disable svelte/no-navigation-without-resolve -- shadcn-generated link variant; callers pass already-resolved route strings (generated code, mirrored from upstream). -->
	<a
		bind:this={ref}
		data-slot="button"
