...
export const ERROR_CODES = {
	...
	// Phase-2 profile/onboarding domain codes (plan §9).
	INVALID_NAME: 'INVALID_NAME',
	NAME_MODERATED: 'NAME_MODERATED',
	NAME_TAKEN: 'NAME_TAKEN',
	INVALID_AVATAR: 'INVALID_AVATAR',
	INCOMPLETE_ONBOARDING: 'INCOMPLETE_ONBOARDING',
	// Phase-4 admin domain codes (plan D10).
	ANSWER_NOT_APPROVED: 'ANSWER_NOT_APPROVED',
	INVALID_HINT: 'INVALID_HINT',
	ANSWER_ALREADY_SCHEDULED: 'ANSWER_ALREADY_SCHEDULED',
	DATE_TAKEN: 'DATE_TAKEN',
	PUZZLE_IMMUTABLE: 'PUZZLE_IMMUTABLE',
