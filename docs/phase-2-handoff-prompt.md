...
3. Read `docs/contradictions-and-gaps.md` (decision log — record every new
   Phase-2 decision here).
4. Read `docs/phase-2-plan.md` (the authoritative Phase-2 plan: decisions,
   API contract, test matrix, definition of done).
5. Read `docs/phase-2-implementation-handoff.md` (state transfer; describes
...
`Specifications-v1.md`, `docs/contradictions-and-gaps.md`, the Phase-2 plan,
...
5. Record every architectural decision in `docs/contradictions-and-gaps.md`.
